...
<head>
    ...
    <title>Samruddha Shala E-Portal - HM Notifications</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <div class="d-flex align-items-center">
                    ...
                    <h5 class="mb-0 fw-bold" id="pageMainHeader">HM Notifications Center</h5>
                </div>
            ...
            <div class="card p-5 text-center shadow-sm border-0 rounded-4 my-3" style="background: linear-gradient(135deg, #ffffff 0%, #f8fafc 100%);">
                <div class="card-body py-4">
                    ...
                    <p class="text-muted fs-6 mx-auto mb-4" style="max-width: 550px; line-height: 1.6;">
                        The <strong>HM Notifications Center</strong> is currently undergoing scheduled maintenance and system upgrades to enhance performance. Please check back again soon!
                    </p>
